    ...
    Button{
        ...
        transitions: [
            ...
            Transition {
                ...
                to: "pressed"
//                PropertyAnimation{ target: bg ;property: "opacity" ; easing.bezierCurve: [0.0784,0.747,0.201,0.988,1,1];duration: 200 }
                PropertyAnimation{ target: icon ;property: "scale" ; easing.bezierCurve: [0.27,0.559,0.327,0.828,1,1];duration: 200 }
        ...
        ToolTip{
            ...
            enter: Transition {
                    ...
                    PropertyAnimation{ target: tooltip ;properties: "x" ; to:  side_bar_button.width + 8; easing.bezierCurve: [0.237,0.582,0.38,0.923,1,1];duration: 130 }
